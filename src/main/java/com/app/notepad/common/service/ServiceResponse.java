package com.app.notepad.common.service;

//import com.app.notepad.common.error;
...
import com.app.notepad.common.error.Status;
...
@XmlType(name = "ServiceResponse", propOrder = { "status", "errors", "header", "payload" })
...
public class ServiceResponse<T> implements Serializable {
    ...
    public String toString() {
        return "ServiceResponse [status=" + status + ", header=" + header + ", errors=" + errors + ", payload="
                + payload + "]";
    }
